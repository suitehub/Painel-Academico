...
export function getInitialData(): AppData {
  ...
  return {
    ...
    ementas: [],
    horariosAulas: [
      { id: "h1", disciplinaId: 101, diaSemana: 1, horaInicio: "08:00", horaFim: "09:40", sala: "Bloco A - Lab 02" },
      { id: "h2", disciplinaId: 102, diaSemana: 1, horaInicio: "10:00", horaFim: "11:40", sala: "Bloco B - Sala 104" },
      { id: "h3", disciplinaId: 104, diaSemana: 2, horaInicio: "08:00", horaFim: "09:40", sala: "Lab Info 3" },
      { id: "h4", disciplinaId: 103, diaSemana: 3, horaInicio: "10:00", horaFim: "11:40", sala: "Auditório" },
      { id: "h5", disciplinaId: 101, diaSemana: 4, horaInicio: "08:00", horaFim: "09:40", sala: "Bloco A - Lab 02" },
      { id: "h6", disciplinaId: 102, diaSemana: 5, horaInicio: "10:00", horaFim: "11:40", sala: "Bloco B - Sala 104" },
    ],
    arquivos: {
      horarios: null,
      calendario: null,
